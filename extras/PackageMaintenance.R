...
OhdsiRTools::checkUsagePackage("IGSNet")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/IGSNet.pdf")
shell("R CMD Rd2pdf ./ --output=extras/IGSNet.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("IGSNet")
