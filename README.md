...
2. In `R`, use the following `devtools` command to install the IGSNet package:
...
License
=======
The IGSNet package is licensed under Apache License 2.0

Development
===========
IGSNet was developed in ATLAS and R Studio.
